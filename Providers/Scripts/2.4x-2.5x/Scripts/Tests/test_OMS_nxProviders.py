...
if nxNPMD != None:
    class nxOMSAgentNPMConfigTestCases(unittest2.TestCase):
        ...
        def setUp(self):
            ...
            dFile = open(nxNPMD.DSC_RESOURCE_VERSION_PATH, 'w+')
            dFile.write('1.0')
            dFile.close()
            dFile = open(nxNPMD.AGENT_RESOURCE_VERSION_PATH, 'w+')
            dFile.write('1.0')
            dFile.close()
        ...
        def testTestSolutionEnable(self):
            ...
            dFile = open(nxNPMD.CONFIG_PATH.__add__(nxNPMD.DEST_FILE_NAME), 'w+')
